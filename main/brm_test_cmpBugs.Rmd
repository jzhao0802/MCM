...
fix_vars <- c(paste0(promo_var, '_adj_stk')
              ,  ctrl_var
)
rnd_vars <- c(fix_vars, ctrl_var[1:2])

library(dplyr)
mu_prec_priors <- data.frame(
      varNm=c(paste0(promo_var, "_adj_stk"), ctrl_var)
...
brm_fit <- brm(formula = 
               ...
               , prior =  c(set_prior('normal(0, 1)', class = 'Intercept')
                            ...
                            , set_prior(getMu('normal', 'call_adj_stk', 'mu', 'stdev'), coef="call_adj_stk", class = 'b')
                            , set_prior(getMu('normal', 'meeting_epu_adj_stk', 'mu', 'stdev'), coef="meeting_epu_adj_stk", class = 'b')
                            , set_prior(getMu('normal', 'meeting_national_adj_stk', 'mu', 'stdev'), coef="meeting_national_adj_stk", class = 'b')
                            , set_prior(getMu('normal', 'meeting_international_adj_stk', 'mu', 'stdev'), coef="meeting_international_adj_stk", class = 'b')
                            , set_prior(getMu('normal', 'meeting_other_adj_stk', 'mu', 'stdev'), coef="meeting_other_adj_stk", class = 'b')
                            
                            , set_prior(getMu('cauchy', 'call_adj_stk', 'stdev', 2.5), coef="call_adj_stk", class='sd', group = IDs_var)
                            , set_prior(getMu('cauchy', 'meeting_epu_adj_stk',  'stdev', 2.5), coef="meeting_epu_adj_stk", class='sd', group = IDs_var)
                            , set_prior(getMu('cauchy', 'meeting_national_adj_stk',  'stdev', 2.5), coef="meeting_national_adj_stk", class='sd', group = IDs_var)
                            , set_prior(getMu('cauchy', 'meeting_international_adj_stk',  'stdev', 2.5), coef="meeting_international_adj_stk", class='sd', group = IDs_var)
                            , set_prior(getMu('cauchy', 'meeting_other_adj_stk',  'stdev', 2.5), coef="meeting_other_adj_stk", class='sd', group = IDs_var)
